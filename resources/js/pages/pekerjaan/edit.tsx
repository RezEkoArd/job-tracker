...
import 'dayjs/locale/id'; // jika pakai lokal Indonesia
import { parse } from 'path';
dayjs.locale('id'); // set default

const breadcrumbs: BreadcrumbItem[] = [
    {
        title: 'Edit a Job Tracker',
        href: route('pekerjaan.index'), // Lebih baik menggunakan helper route
    },
];
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex items-center gap-4">
                        <Button type="submit" disabled={processing}>
                            {processing ? 'Saving...' : 'Edit Job Tracker'}
                        </Button>
                    </div>
                </form>
            </div>
